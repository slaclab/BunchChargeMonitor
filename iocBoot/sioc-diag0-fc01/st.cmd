...
epicsEnvSet("IOC_NAME","SIOC:DIAG0:FC01")
...
dbLoadRecords("db/farady_cup_coef_calib.db", "P=${AMC_CARRIER_PREFIX}")
dbLoadRecords("db/coefficientScaling.db", "P=${AMC_CARRIER_PREFIX}")
...
# *************************************************************************
# **** Load message status   **********************************************
dbLoadRecords("db/msgStatus.db","P=${AMC_CARRIER_PREFIX},DESC=Communications Diagnostics,BPM_LOCA=314,LOCA=$(UNIT),AREA=DIAG0")
