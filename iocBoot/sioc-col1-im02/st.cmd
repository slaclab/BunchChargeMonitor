...
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:BC1B:850, R=1, IOC=${IOC_NAME},NODE=1,INP=1, TYPE=TempPrimPyro, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=TORO:COL1:125, R=1, IOC=${IOC_NAME},NODE=2,INP=1, TYPE=TempElc, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=TORO:COL1:125, R=2, IOC=${IOC_NAME},NODE=3,INP=1, TYPE=TempRef, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=TORO:COL1:125, R=3, IOC=${IOC_NAME},NODE=3,INP=2, TYPE=TempAmpRef, ESLO=${ESLO}, EOFF=${EOFF}")
#dbLoadRecords("db/multTempMonitoring.db", "P=, R=1, IOC=${IOC_NAME},NODE=4,INP=1, TYPE=TempGapLeft, ESLO=${ESLO}, EOFF=${EOFF}")
#dbLoadRecords("db/multTempMonitoring.db", "P=, R=2, IOC=${IOC_NAME},NODE=4,INP=2, TYPE=TempGapTop, ESLO=${ESLO}, EOFF=${EOFF}")
#dbLoadRecords("db/multTempMonitoring.db", "P=, R=3, IOC=${IOC_NAME},NODE=5,INP=1, TYPE=TempGapRight, ESLO=${ESLO}, EOFF=${EOFF}")
#dbLoadRecords("db/multTempMonitoring.db", "P=, R=4, IOC=${IOC_NAME},NODE=5,INP=2, TYPE=TempGapBtm, ESLO=${ESLO}, EOFF=${EOFF}")
