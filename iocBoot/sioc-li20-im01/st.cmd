...
epicsEnvSet("AMC1_POS", "2988")
epicsEnvSet("AMC0_POS", "2040")
epicsEnvSet("IOC_UNIT", "IM01")

# BCM-TORO in crate 1, slot 3, AMC 1 (IM1988)
epicsEnvSet("AMC1_PREFIX", "TORO:$(AREA):$(AMC1_POS)")
# BCM-TORO in crate 1, slot 3, AMC 0 (IM2040)
epicsEnvSet("AMC0_PREFIX", "TORO:$(AREA):$(AMC0_POS)")

# AMCC in crate 1, slot 3
...
dbLoadRecords("db/bcmAmc.db", "P=$(AMC1_PREFIX), PORT=$(CPSW_PORT), AMC=1")

dbLoadRecords("db/bcmChan.db", "P=$(AMC0_PREFIX):0, PORT=$(CPSW_PORT), AMC=0, CHAN=0")
dbLoadRecords("db/bcmChan.db", "P=$(AMC1_PREFIX):0, PORT=$(CPSW_PORT), AMC=1, CHAN=0")

dbLoadRecords("db/bcmChan.db", "P=$(AMC0_PREFIX):1, PORT=$(CPSW_PORT), AMC=0, CHAN=1")
dbLoadRecords("db/bcmChan.db", "P=$(AMC1_PREFIX):1, PORT=$(CPSW_PORT), AMC=1, CHAN=1")
...
dbLoadRecords("db/facet2Calibration.db", "P=$(AMC1_PREFIX),CHAN=0")
dbLoadRecords("db/facet2Calibration.db", "P=$(AMC0_PREFIX),CHAN=1")
dbLoadRecords("db/facet2Calibration.db", "P=$(AMC1_PREFIX),CHAN=1")
