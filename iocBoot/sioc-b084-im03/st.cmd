...
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:HTR:350, R=1, IOC=${IOC_NAME},NODE=1, INP=1, TYPE=TempPrimPyro, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=TORO:GUNB:360, R=1, IOC=${IOC_NAME},NODE=2,INP=1, TYPE=TempElc, ESLO=${ESLO}, EOFF=${EOFF}")
...
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:HTR:350, R=2, IOC=${IOC_NAME},NODE=4,INP=1, TYPE=TempGapLeft, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:HTR:350, R=3, IOC=${IOC_NAME},NODE=4,INP=2, TYPE=TempGapTop, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:HTR:350, R=4, IOC=${IOC_NAME},NODE=5,INP=1, TYPE=TempGapRight, ESLO=${ESLO}, EOFF=${EOFF}")
dbLoadRecords("db/multTempMonitoring.db", "P=BLEN:HTR:350, R=5, IOC=${IOC_NAME},NODE=5,INP=2, TYPE=TempGapBtm, ESLO=${ESLO}, EOFF=${EOFF}")
